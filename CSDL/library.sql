...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th9 13, 2022 lúc 03:50 PM
...
CREATE TABLE `account` (
  ...
  `namsinh` text COLLATE utf8_vietnamese_ci DEFAULT NULL,
...
CREATE TABLE `document` (
  ...
  `filename` text COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `title` text COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `thumbnail` text COLLATE utf8_vietnamese_ci DEFAULT NULL,
...
(1, 1, 2, 1, 'HTML.pdf', 'Tài Liệu HTML/CSS ', 'htmlcss.jpg', 13, 0, 1, 0, '0000-00-00 00:00:00', '2022-01-14 01:35:08'),
(2, 1, 1, 3, 'javacoban.pdf', 'Tài Liệu Java ', 'java.jpg', 40, 0, 1, 0, '0000-00-00 00:00:00', '2022-01-14 01:35:10'),
(4, 0, 2, 2, 'Lap trinh web php-main - 2017 (3).pptx', 'Tài Liệu PHP', 'php.jpg', 16, 0, 1, 0, '2021-11-07 02:07:08', '2022-01-14 01:35:03'),
(5, 0, 2, 3, 'EffectiveJava.pdf', 'Sách Effective Java', 'effectivejava.jpg', 10, 0, 1, 0, '2021-11-09 01:21:52', '2022-01-14 01:35:06'),
(11, 0, 2, 3, 'OOP_JAVA.pdf', 'Lập trình hướng đối tượng JAVA', 'OOP_java.png', 0, 0, 1, 0, '2021-12-14 06:42:54', '2021-12-14 08:01:47'),
(12, 0, 2, 3, 'thinkjava.pdf', 'Sách Think Java', 'thinkjava.jpg', 5, 0, 1, 0, '2021-12-14 06:52:59', '2021-12-14 08:01:48'),
...
(15, 0, 2, 17, 'JS.pdf', 'Tài liệu JavaScript', 'Javascript.png', 2, 0, 1, 0, '2021-12-14 07:02:17', '2021-12-14 08:01:51'),
(17, 0, 2, 23, 'OOP_ccc.pdf', 'Lập trình hướng đối tượng C++', 'OOP_ccc.jpg', 0, 0, 1, 0, '2021-12-14 07:14:56', '2021-12-14 08:01:53'),
(19, 0, 2, 18, 'learnpythehardway.pdf', 'Sách Learn Python The Hard Way', 'sachpy.jpg', 1, 0, 1, 0, '2021-12-14 07:21:49', '2021-12-16 09:03:36'),
(20, 0, 2, 18, 'pycookbook.zip', 'Sách Python Cook Book', 'pycookbook.jpg', 3, 0, 1, 0, '2021-12-14 07:36:36', '2021-12-16 12:46:27'),
(24, 0, 2, 2, 'Giao Trinh PHP.pdf', 'Giáo trình PHP', 'phptl.jpg', 0, 0, 1, 0, '2021-12-16 08:01:52', '2021-12-16 09:03:37'),
(23, 0, 1, 3, 'sach Java 8 Action.zip', 'Sách Java in 8 Action', 'sachjavain8action.jpg', 1, 0, 1, 0, '2021-12-14 07:56:51', '2021-12-16 12:46:29'),
...
ALTER TABLE `comment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_comment_account` (`user_id`),
  ADD KEY `fk_comment_document` (`document_id`);
