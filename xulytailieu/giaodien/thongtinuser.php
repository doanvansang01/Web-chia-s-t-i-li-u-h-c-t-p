...
<body>
    ...
    <div id="wrapper" style="margin: 100 0 0 0;">
        <div class="tabs">
            <ul class="nav-tabs">
                <li class="active"><button class="btnDKLN" href="thongtinuser.php">Thông tin</button></li>
                <li><button class="btnDKLN" href="#menu_2">Đổi mật khẩu</button></li>
            </ul>
        </div>
					...
					<div class="panel-body table-responsive">
						<form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>">
							...
							<div class="form-group" style="width:50%">
							 ...
							 <button class="btn btn-success bt"  name="dk">Cập nhật
						</form>
					</div>