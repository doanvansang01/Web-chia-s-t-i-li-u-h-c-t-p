	...
	if(isset($_GET['path']))
	{
		...
		if(file_exists($fn) && isset($_SESSION['login']) ) {
			...
			{	
				...
				echo "<script type='text/javascript'>alert('$message');window.location='http://localhost/baitapcuoiky/projectcuoiky/xulytailieu/giaodien/upload.php'</script>";		
				die();
		...
		?>
		  ...
		  <div className="row" style="background-color: #f7f7f7;">
			...
			<section style="margin-left: 260px; margin-top: 30px">
				<h2 style="color: blue">Thông tin tài liệu</h2>
